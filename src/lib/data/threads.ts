	...
	entries: [
		{
			...
			isOrchestrator: true,
			time: '10:02',
			paragraphs: ['We need an eval for the retrieval layer. Kestrel, take metrics. Wren, find prior art.']
		},
		{
			kind: 'message',
			id: 'm2',
	...
	activity: [
		{
			...
			steps: [
				...
				{ id: 's6', state: 'ok', name: 'reader-3', detail: 'LoTTE splits', duration: '9s', child: true },
				{
					id: 's7',
					state: 'ok',
					name: 'write_doc',
		...
		},
		{
			label: '10:12 · Kestrel',
			steps: [
				{ id: 's8', state: 'ok', name: 'skill_search', detail: '"llm judge rubric"', duration: '0.2s' },
				{ id: 's9', state: 'ok', name: 'skill_read', detail: 'eval-harness', duration: '0.1s' },
				{ id: 's10', state: 'ok', name: 'write_doc', detail: 'eval-protocol-v1.md', duration: '0.6s' }
			]
		},
		{
			label: '10:15 · Finch',
			steps: [
				{ id: 's11', state: 'ok', name: 'skill_write', detail: 'relevance-judge', duration: '0.3s' },
				{ id: 's12', state: 'run', name: 'run_eval', detail: 'sample n=200, seed=7', duration: 'running' }
			]
		}
	],
	...
	entries: [
		{
			...
			isOrchestrator: true,
			time: '08:40',
			paragraphs: ['Does a bigger context window actually help once retrieval is good? Kestrel, design it.']
		},
		{
			kind: 'message',
			id: 'b2',
		...
		},
		{
			...
			tag: 'analyst',
			time: '09:31',
			paragraphs: ['Running sweep at n=8 with the token budget held fixed. First cells land in ~20 min.']
		}
	],
	activity: [
		{
			label: '08:55 · Kestrel',
			steps: [
				{ id: 'bs1', state: 'ok', name: 'skill_read', detail: 'ablation-planner', duration: '0.1s' },
				{ id: 'bs2', state: 'ok', name: 'write_doc', detail: 'ablation-design.md', duration: '0.5s' },
				{
					id: 'bs3',
					state: 'run',
					name: 'run_sweep',
	...
	entries: [
		{
			...
			tag: 'researcher',
			time: 'Yesterday',
			paragraphs: ['22 papers clustered into four families. Most reported speedups do not survive a fair wall-clock comparison.'],
	...
	activity: [
		{
			...
			steps: [
				{ id: 'cs1', state: 'ok', name: 'web_search', detail: '"sparse attention survey"', duration: '1.1s' },
				{ id: 'cs2', state: 'ok', name: 'write_doc', detail: 'sparse-attention-survey.md', duration: '0.7s' }
			]
		}
	],
	...
	activity: [
		{
			...
			steps: [
				...
				{ id: 'ds2', state: 'ok', name: 'write_doc', detail: 'licensing-audit.md', duration: '0.4s' }
			]
		}
	],
